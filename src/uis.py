...
<ui version="4.0">
 ...
 <widget class="QWidget" name="dlg">
  ...
  <layout class="QVBoxLayout" name="verticalLayout">
   <item>
    <widget class="QFrame" name="frt_filter">
     <property name="minimumSize">
      <size>
       <width>0</width>
       <height>68</height>
     ...
     <layout class="QHBoxLayout" name="horizontalLayout">
      ...
      <item>
       <widget class="QToolButton" name="tbt_run_delete">
        <property name="enabled">
         <bool>true</bool>
        </property>
        ...
        <property name="icon">
         <iconset>
          <normaloff>:/img/img/trash.png</normaloff>:/img/img/trash.png</iconset>
        </property>
      ...
      <item>
       <widget class="QLineEdit" name="let_filter">
        <property name="sizePolicy">
      ...
      <item>
       <widget class="QToolButton" name="tbt_new">
        <property name="sizePolicy">
      ...
      <item>
       <widget class="QToolButton" name="tbt_save">
        <property name="sizePolicy">
         <sizepolicy hsizetype="Fixed" vsizetype="Fixed">
          <horstretch>0</horstretch>
          <verstretch>0</verstretch>
      ...
      <item>
       <widget class="QToolButton" name="tbt_duplicate">
        <property name="sizePolicy">
         <sizepolicy hsizetype="Fixed" vsizetype="Fixed">
          <horstretch>0</horstretch>
          <verstretch>0</verstretch>
      ...
      <item>
       <widget class="QToolButton" name="tbt_show_delete">
        <property name="sizePolicy">
         <sizepolicy hsizetype="Fixed" vsizetype="Fixed">
          <horstretch>0</horstretch>
          <verstretch>0</verstretch>
   ...
   <item>
    <widget class="QFrame" name="frt__edit">
     <property name="sizePolicy">
     ...
     <layout class="QVBoxLayout" name="verticalLayout_2">
      ...
      <item>
       <widget class="QWidget" name="widget" native="true">
        <layout class="QHBoxLayout" name="horizontalLayout_2" stretch="0,0">
         ...
         <item>
          <widget class="QLineEdit" name="let_name">
           <property name="sizePolicy">
            <sizepolicy hsizetype="Expanding" vsizetype="Minimum">
             <horstretch>0</horstretch>
             <verstretch>0</verstretch>
         ...
         <item>
          <widget class="QLineEdit" name="let_name_index">
           <property name="sizePolicy">
            <sizepolicy hsizetype="Expanding" vsizetype="Minimum">
             <horstretch>0</horstretch>
             <verstretch>0</verstretch>
      ...
      <item>
       <widget class="QDateTimeEdit" name="dtet_date">
        <property name="sizePolicy">
         <sizepolicy hsizetype="Minimum" vsizetype="Minimum">
          <horstretch>0</horstretch>
          <verstretch>0</verstretch>
      ...
      <item>
       <widget class="QLineEdit" name="let_about">
        <property name="sizePolicy">
         <sizepolicy hsizetype="Expanding" vsizetype="Minimum">
          <horstretch>0</horstretch>
          <verstretch>0</verstretch>
